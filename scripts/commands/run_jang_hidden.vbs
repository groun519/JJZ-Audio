...
commandDir = fso.GetParentFolderName(WScript.ScriptFullName)
appDir = fso.GetParentFolderName(fso.GetParentFolderName(commandDir))
batPath = fso.BuildPath(commandDir, "run_jang.bat")
