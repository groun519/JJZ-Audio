...
> [!NOTE]
> 이 문서는 정식 배포된 **JJZero Audio 0.3.10** 기준으로 작성되어 있습니다. 설치 파일은 [GitHub Releases](https://github.com/groun519/JJZ-Audio/releases/latest)에서 받을 수 있습니다.

스튜디오 다중 편집과 프로젝트 복구, RVC 학습 및 업데이트 안정성 개선은 [0.3.10 패치노트](docs/releases/0.3.10.md)에서 확인할 수 있습니다.
...
| **스튜디오** | 오디오·비디오 사운드 풀, 자석 정렬 기반 비파괴 타임라인 편집, 분할·트림·이동·FX·뮤트·음량 조절과 믹싱 |
