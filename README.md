...
> [!NOTE]
> 이 문서는 정식 배포된 **JJZero Audio 0.3.7** 기준으로 작성되어 있습니다. 설치 파일은 [GitHub Releases](https://github.com/groun519/JJZ-Audio/releases/latest)에서 받을 수 있습니다.

단일 GPU RVC 학습 정지 수정 사항은 [0.3.7 패치노트](docs/releases/0.3.7.md)에서 확인할 수 있습니다.
