...
def classify_error(error: str) -> ErrorClassification:
    value = error.lower()
    rules = (
        (("no module named 'lib.jjzero_device'", 'no module named "lib.jjzero_device"'), "RVC_RUNTIME_INCOMPLETE", "The installed RVC runtime is missing a JJZero compatibility component."),
